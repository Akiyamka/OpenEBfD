...
| `B5` | pending | 2026-08-27 | Stopped `CombatTurret` measuring rules range from the interpolated `visual_root`, which made an in-range verdict depend on frame pacing; buildings deliberately untouched | [Slice B5, decided 2026-08-27: a firing decision](network-multiplayer.md#order-of-work) |
