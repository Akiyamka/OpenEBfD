...
| `R7` | pending | 2026-08-28 | Migrated the last thirty entity reads across fourteen files and emptied the read rule's queued group, leaving a permanent half and seven hatched lines that have no store entry to read instead | [Slice R7, decided 2026-08-28: the tail](network-multiplayer.md#order-of-work) |
